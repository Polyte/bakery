...
export async function GET(request: Request) {
  ...
  try {
    ...
    console.error("Admin income list failed:", error)
    return NextResponse.json({ error: "Could not load income." }, { status: 500 })
  }
}
...
export async function POST(request: Request) {
  ...
  try {
    ...
    console.error("Admin income create failed:", error)
    return NextResponse.json({ error: "Could not create income." }, { status: 500 })
  }
}
